...
if (isset($_POST['submit'])) {
    ...
    if (empty($billingNumber) || $productID <= 0 || $quantity <= 0 || $returnPrice < 0) {
        echo "<script>alert('Invalid data. Please check billing number, product, quantity, and price.');</script>";
    } else {
        ...
        if ($queryInsert) {
            ...
            echo "<script>alert('Return recorded (with custom price) and stock updated!');</script>";
        } else {
            echo "<script>alert('Error inserting return record.');</script>";
        }
    }
    // Refresh
...
<html lang="en">
<head>
    <title>Inventory Management | Product Returns</title>
...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="return.php" class="current">Product Returns</a>
      </div>
      <h1>Manage Product Returns</h1>
    </div>
                  ...
                  <div class="widget-content nopadding">
                    <form method="post" class="form-horizontal">
                      ...
                      <div class="control-group">
                        <label class="control-label">Invoice/Billing Number :</label>
                        <div class="controls">
                          <input type="text" name="billingnumber" placeholder="e.g. 123456789" required />
                        </div>
                      </div>
                      ...
                      <!-- Quantity -->
                      <div class="control-group">
                        <label class="control-label">Quantity Returned :</label>
                        <div class="controls">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" name="reason" placeholder="e.g. Defective, Wrong size, etc." />
                        </div>
                      </div>
