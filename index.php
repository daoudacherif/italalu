...
<head>
  <meta charset="UTF-8">
  <title>ITALALU - Aluminium & Matériaux de Construction</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="description" content="Italal : importation et vente de matériaux en aluminium en République de Guinée.">

  <!-- Feather Icons (pour les icônes) -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/feather-icons/4.28.0/feather.min.js"
          integrity="sha512-U7ZxW5X9dCt1p2FoZMCa4U+AGnSGhCXN6Nnx8bDYqco3dD4M9rRksZs1yyiN6tACy4Rh9G8dwe+TeWeB2vFpKA=="
          crossorigin="anonymous" referrerpolicy="no-referrer"></script>

  <!-- Google Fonts (ex. Poppins) -->
  <link rel="preconnect" href="https://fonts.gstatic.com" />
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet" />

  <!-- FontAwesome (pour quelques icônes supplémentaires) -->
  ...
  <style>
    ...
    * {
    ...
    .hero {
	  ...
	  background-image: url('images/warehouse-5635000_1280.jpg');
      position: relative;
      overflow: hidden;
      text-align: center;
      color: #fff;
...
<header>
  ...
  <nav>
    <ul>
      ...
      <li><a href="#" style="color:#fffa;">Contact</a></li>
    </ul>
  </nav>
</header>
